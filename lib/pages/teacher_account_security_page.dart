...
import 'teacher_change_password_page.dart';
...
/// 教师账号安全页面
class TeacherAccountSecurityPage extends StatefulWidget {
  const TeacherAccountSecurityPage({super.key});

  @override
  State<TeacherAccountSecurityPage> createState() => _TeacherAccountSecurityPageState();
}

class _TeacherAccountSecurityPageState extends State<TeacherAccountSecurityPage> {
          ...
          _buildSecurityItem(
            ...
            onTap: () async {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const TeacherChangePasswordPage(),
                ),
              );
              // 如果密码修改成功，刷新数据
              if (result == true) {
