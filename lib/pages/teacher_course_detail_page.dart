...
class _TeacherCourseDetailPageState extends State<TeacherCourseDetailPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 使用FutureBuilder加载最新公告
          FutureBuilder<ApiResponse<List<Announcement>>>(
            future: AnnouncementService.getLatestAnnouncements(widget.courseId, limit: 3),
            builder: (context, snapshot) {
              ...
              final announcements = snapshot.data!.body ?? [];
              ...
              return Column(
                children: announcements.map((announcement) => 
                  Container(
                    ...
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                      color: _getAnnouncementBackgroundColor(announcement.announcementType),
                      borderRadius: BorderRadius.circular(8),
                      border: announcement.announcementType != AnnouncementType.normal
                          ? Border.all(
                              color: _getAnnouncementBorderColor(announcement.announcementType),
                              width: 1,
                            )
                          : null,
                    ),
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 8,
                          decoration: BoxDecoration(
                            color: _getAnnouncementIndicatorColor(announcement.announcementType),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  if (announcement.announcementType != AnnouncementType.normal)
                                    Container(
          ...
          Center(
            child: TextButton(
              onPressed: () => _navigateToAnnouncementList(),
              child: const Text(
                '查看更多公告',
                style: TextStyle(
  ...
  /// 获取公告背景颜色
  Color _getAnnouncementBackgroundColor(AnnouncementType type) {
    switch (type) {
  ...
  /// 获取公告边框颜色
  Color _getAnnouncementBorderColor(AnnouncementType type) {
    switch (type) {
      case AnnouncementType.important:
  ...
  /// 获取公告指示器颜色
  Color _getAnnouncementIndicatorColor(AnnouncementType type) {
    switch (type) {
      case AnnouncementType.important:
        return const Color(0xFFFF9800);
      case AnnouncementType.urgent:
