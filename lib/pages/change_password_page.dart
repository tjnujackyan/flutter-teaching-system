...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> _changePassword() async {
    ...
    try {
      print('发送修改密码请求: verifyToken=${_verifyToken}, newPassword长度=${_newPasswordController.text.length}, confirmPassword长度=${_confirmPasswordController.text.length}');
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      color: _countdown > 0 ? const Color(0xFF999999) : const Color(0xFF4285F4),
                    ),
                  ),
                ),
              ],
