...
class _TeacherProfileInfoPageState extends State<TeacherProfileInfoPage> with SingleTickerProviderStateMixin {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Container(
            ...
            child: const Icon(Icons.arrow_back_ios_new, size: 18, color: Color(0xFF4CAF50)),  // 绿色
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      _nameController.text.isNotEmpty ? _nameController.text : '教师姓名',
  ...
  Widget _buildDefaultAvatar() {
    return Container(
      ...
      child: Center(
        child: Text(
          _nameController.text.isNotEmpty ? _nameController.text[0] : '教',
          style: const TextStyle(
            fontSize: 48,
            fontWeight: FontWeight.bold,
      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.person_outline, color: Color(0xFF4CAF50), size: 24),  // 绿色
                SizedBox(width: 12),
                Text(
                  '基本信息',
                  style: TextStyle(
  ...
  Widget _buildGenderOption(String gender) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 10),
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF4CAF50) : const Color(0xFFF2F2F7),
          borderRadius: BorderRadius.circular(20),
        ),
        child: Text(
          gender,
